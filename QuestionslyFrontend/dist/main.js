...
/* harmony import */ var _create_community_create_community_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./create-community/create-community.component */ "./src/app/create-community/create-community.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _create_community_create_community_component__WEBPACK_IMPORTED_MODULE_25__["CreateCommunityComponent"],
...
/* harmony import */ var _create_community_create_community_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./create-community/create-community.component */ "./src/app/create-community/create-community.component.ts");
...
var APP_ROUTES = [
    ...
    { path: 'createGroup', component: _create_community_create_community_component__WEBPACK_IMPORTED_MODULE_8__["CreateCommunityComponent"] },
...
var AskQuestionComponent = /** @class */ (function () {
    ...
    AskQuestionComponent.prototype.deactivateDimmer = function () {
        if (this.question) {
            ...
            this.activeDimmer = false;
            jquery__WEBPACK_IMPORTED_MODULE_7__('.fBody, .cBody').css({ 'z-index': 2 });
            jquery__WEBPACK_IMPORTED_MODULE_7__('.cBody').css({ 'z-index': 1 });
        }
    };
...
var CreateCommunityComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], CreateCommunityComponent.prototype, "category", void 0);
...
var HomePageComponent = /** @class */ (function () {
    ...
    HomePageComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            _this.viewGroupId = params.groupid;
...
module.exports = "<div class=\"sb-container\">\n    <div class=\"header\">\n        <span class=\"brand-text\">Questionsly</span>\n    </div>\n\n    <div class=\"group-section\">\n        <!-- <h4 class=\"section-entry\" [ngClass]=\"{active: '' == activeGroup}\"> -->\n            <a class=\"section-entry\" [ngClass]=\"{active: '' == activeGroup}\" [routerLink]=\"['/']\">\n                {{orgName}}\n            </a>\n        <!-- </h4> -->\n    </div>\n\n    <div *ngFor=\"let category of categories\" class=\"group-section\">\n        <h4 class=\"section-title\">{{category.displayNamePlural}}</h4>\n\n        <!-- <h4 *ngFor=\"let group of category.groups\" class=\"section-entry\" [ngClass]=\"{active: group.title == activeGroup}\"> -->\n            <a *ngFor=\"let group of category.groups\" class=\"section-entry\" [ngClass]=\"{active: group.title == activeGroup}\" [routerLink]=\"['/']\" [queryParams]=\"{groupid: group.id}\">\n                {{group.title}}\n            </a>\n        <!-- </h4> -->\n\n        <!-- <h4 class=\"section-entry dim\" (click)=\"openCreateGroupModal(category)\"> -->\n            <a class=\"section-entry dim\" (click)=\"openCreateGroupModal(category)\">\n                + Add {{category.displayNameShort}}\n            </a>\n        <!-- </h4> -->\n    </div>\n</div>\n\n<ng-template #createGroupModal let-c=\"close\" let-d=\"dismiss\">\n    <app-create-community [category]=\"createGroupCategory\"></app-create-community>\n</ng-template>\n"
...
var NewSidebarComponent = /** @class */ (function () {
    function NewSidebarComponent(http, modalService) {
        this.http = http;
        this.modalService = modalService;
        this.categories = [];
        this.orgName = '';
