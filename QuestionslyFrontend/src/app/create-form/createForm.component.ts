...
export class CreateFormComponent implements OnInit, OnDestroy {
    ...
    getSortedQuestions() {
        return this.questionData.sort((a, b) => a.number - b.number);
    }
    ...
    createForm() {
        ...
        if (this.edit) {
            ...
            for (let question of data.questions) {
                ...
                (<FormArray>this.questionnaire.controls['questions']).push(this.fb.group(question));
            }
    ...
    deleteQuestion(i) {
        ...
        const questions = (<FormArray>this.questionnaire.controls["questions"])
    ...
    */
    ...
    moveUp(i: number) {
        ...
        if (i == 0) return;
        const currentNum = this.questionData[i].number;
