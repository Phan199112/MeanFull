...
export class SettingsComponent implements OnInit {
    ...
    profilepublic = {form: null, question: {}};
    notificationsettings = {form: null, question: {}};
    generalQuestions: any[];
    educationfield = {edit: false, values: null, summary: ''};
    network: any[];
    notifications: any[];
    reject: boolean = false;
    picture = {edit: false, formValue: null, current: null, newurl: null, success: false, failure: false};
                        ...
                        'Yes': [
                            {
                                ...
                                name: 'school',
                                type: 'dropdown',
                                options: this.UsaSchools.map(school => {
    ...
    postGeneralQuestions() {
        this.http.put('/users/settings/generalQuestions', {data: this.generalQuestionsForm.value}).toPromise()
            .then(res => {
                (this.generalQuestionsForm as any).submitted = true;
                (this.generalQuestionsForm as any).submittedValue = this.generalQuestionsForm.value;
