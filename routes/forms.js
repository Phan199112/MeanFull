...
module.exports = function(app, passport, manager, hashids) {
    ...
    app.post('/forms/feed', manager.ensureLoggedIn('/users/login'), usersfunctions.ensureAuthenticatedUserInSession, function (req, res, next) {
        ...
        var firstform = {};
        var groupsForAuthenticatedUser = [];
        ...
        //
        new Promise(function(resolve, reject) {
            if (selectedcomm == 'mine') {
                GroupModel.find({members: req.session.userid}).cursor()
            ...
            .then(function() {
                queryobj = postfunctions.getPostFilterFor(
                    ...
                    selecteduser,
                    selectedcomm == 'mine' ? groupsForAuthenticatedUser : selectedcomm,
                    selectedtags,
                    req.session.userid
                );
